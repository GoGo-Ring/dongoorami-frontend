...
const CompanionRecruitmentCardContainer = ({
  children,
}: CompanionRecruitmentCardProps) => {
  return <div className=" w-[204px] rounded-lg border p-6">{children}</div>;
};

CompanionRecruitmentCardContainer.Title = Title;
CompanionRecruitmentCardContainer.ConditionItem = ConditionItem;
CompanionRecruitmentCardContainer.ContentField = ContentField;
CompanionRecruitmentCardContainer.IconWithCountItem = IconWithCountItem;
CompanionRecruitmentCardContainer.IconField = IconField;
CompanionRecruitmentCardContainer.UserId = UserId;
CompanionRecruitmentCardContainer.CreatedDate = CreatedDate;
CompanionRecruitmentCardContainer.BadgeItem = BadgeItem;
CompanionRecruitmentCardContainer.FooterField = FooterField;

export default CompanionRecruitmentCardContainer;
